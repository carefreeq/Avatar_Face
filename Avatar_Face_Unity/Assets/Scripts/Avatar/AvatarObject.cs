...
namespace Avatar
{
    ...
    public class AvatarObject : MonoBehaviour
    {
        ...
        /// 角色脸部模型
        /// </summary>
        public SkinnedMeshRenderer Face { get { if (!face) face = transform.Find("Face").GetComponent<SkinnedMeshRenderer>(); return face; } private set { face = value; } }
        /// <summary>
        /// 角色头发模型
        /// </summary>
        public SkinnedMeshRenderer Hair { get { if (!hair) hair = transform.Find("Hair").GetComponent<SkinnedMeshRenderer>(); return hair; } private set { hair = value; } }
        /// <summary>
        /// 角色上身身体模型
        /// </summary>
        public SkinnedMeshRenderer UpperBody { get { if (!upperBody) upperBody = transform.Find("UpperBody").GetComponent<SkinnedMeshRenderer>(); return upperBody; } private set { upperBody = value; } }
        /// <summary>
        /// 角色上身布料模型
        /// </summary>
        public SkinnedMeshRenderer UpperCloth { get { if (!upperCloth) upperCloth = transform.Find("UpperCloth").GetComponent<SkinnedMeshRenderer>(); return upperCloth; } private set { upperCloth = value; } }
        /// <summary>
        /// 角色下身身体模型
        /// </summary>
        public SkinnedMeshRenderer LowerBody { get { if (!lowerBody) lowerBody = transform.Find("LowerBody").GetComponent<SkinnedMeshRenderer>(); return lowerBody; } private set { lowerBody = value; } }
        /// <summary>
        /// 角色下身布料模型
        /// </summary>
        public SkinnedMeshRenderer LowerCloth { get { if (!lowerCloth) lowerCloth = transform.Find("LowerCloth").GetComponent<SkinnedMeshRenderer>(); return lowerCloth; } private set { lowerCloth = value; } }
        /// <summary>
        /// 角色鞋子模型
        /// </summary>
        public SkinnedMeshRenderer Shoes { get { if (!shoes) shoes = transform.Find("Shoes").GetComponent<SkinnedMeshRenderer>(); return shoes; } private set { shoes = value; } }
        ...
        public Dictionary<string, Transform> Bones
        {
            get
            {
                if (bones == null)
                {
                    ...
                    Transform[] trans = transform.Find("Bip001").GetComponentsInChildren<Transform>();
